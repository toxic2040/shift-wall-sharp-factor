...
\end{center}
Only the top few coefficients of each wall row are consumed, so the producer
carries a fixed-width top window of the recurrence and reaches $r=45082$ in
well under a minute.
